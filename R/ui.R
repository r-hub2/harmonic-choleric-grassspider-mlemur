mlemurUI <- function(request) {
  fluidPage(
    ...
    navbarPage(fluid = FALSE,
               ...
               footer = column(12,
                               hr(),
                               HTML("<center>mlemur: MLE Mutation Rate Calculator v1.0 | 2024 | GPL-2</center>"),
                 ...
                 fluidRow(
                   column(
                     ...
                     div(
                       ...
                       shinyjqui::orderInput(inputId = 'FoldStrains', label = 'Strains', items = sapply(1:8, function(x) paste("Strain", x)),
                     ...
                     br(),
                     shinyjs::hidden(
                       sliderInput(inputId = "FoldNumberOfStrains", label = "Number of strains", min = 2, max = 8, value = 2, step = 1)
                     ),
                     hr(),
                     ...
                     fluidRow(
                       ...
                       shinyjs::hidden(
                         column(
                           ...
                           id = "FoldColumn7",
                           style = "min-width: 300px;",
                           h4(HTML("<b>Strain 7</b>")),
                           countsPlatingUI("CountsStrain7Fold", "SettingsFold", TRUE, usePreset = 2, defaultSettings = c(0, 1, 2)),
                         )
                       ),
                       shinyjs::hidden(
                         column(
                           ...
                           id = "FoldColumn8",
                           style = "min-width: 300px;",
                           h4(HTML("<b>Strain 8</b>")),
                           countsPlatingUI("CountsStrain8Fold", "SettingsFold", TRUE, usePreset = 2, defaultSettings = c(0, 1, 2)),
                         )
                       )
                     ),
                     br(),
